    ...
    const tools: Tool[] = [
      {
        ...
        description: "Read the visible frontend demonstration state. All data is synthetic.",
        inputSchema: {
          type: "object",
          properties: {},
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            view: {
              enum: props.fixedView ? [props.fixedView] : ["command", "officer", "hospital"],
            },
        ...
        execute: async (input) => {
          ...
          if (
            ...
            (x.personId !== undefined && !PEOPLE.some((p) => p.id === x.personId))
          )
