...
vi.mock("./OperationsMap", () => ({
  OperationsMap: ({ selectedId }: { selectedId: string }) => <div data-testid="map-selection">{selectedId}</div>,
}));
...
describe("workspace entry points", () => {
  ...
  ] as const)("opens the fixed %s workspace without role switching controls", (workspace, label, heading) => {
