...
| `apps/paw-patrol` Officer, Command, Hospital views | Supply shared server state through a live data adapter. Current browsers run independent synthetic sessions. |
